...
Vt1s = [2250, 2250, 2250, 2250, 2250, 2250, 2250, 2250, 2250]
V0s = [13.0, 13.0, 13.0, 13.0, 13.0, 13.0, 13.0, 13.0, 13.0]
DSs = [0.1, 0.5, 1.0, 2.0, 4.0, 7.0, 10.0, 15.0, 20.0]

# returns binary absolute path, settings absolute path and log file absolute path (str1, str2, str3)
def prepare_settings(V0, Vth1, DrSt):
    ...
    for line in fileinput.input([abs_settings], inplace=True):
        ...
        l = l.replace('DRIFT_STEP', str(round(DrSt, 1)))
...
if __name__ == "__main__":
    ...
    for i in range(min(len(V0s), len(Vt1s))):
        print ("****************************************************************")
        print ("****************************************************************")
        print ("Starting simulating V0 = " + str(round(V0s[i], 1)) + ", Vthgem = " + str(round(Vt1s[i])) + ", Drift_step = " + str(round(DSs[i], 1)) )
        print ("****************************************************************")
        print ("****************************************************************")
        ...
        if not p1.returncode is None:
            print ("****************************************************************")
            print ("****************************************************************")
            print("ERROR while running " + binary + ". Skipping V0= " + str(round(V0s[i], 1)) + ", Vthgem= " + str(round(Vt1s[i])) + ", Drift_step = " + str(round(DSs[i], 1)) )
            print ("****************************************************************")
            print ("****************************************************************")
            continue
        print ("****************************************************************")
        print ("****************************************************************")
        print ("Ended simulating V0 = " + str(round(V0s[i], 1)) + ", Vthgem = " + str(round(Vt1s[i])) + ", Drift_step = " + str(round(DSs[i], 1)) )
        print ("****************************************************************")
        print ("****************************************************************")
