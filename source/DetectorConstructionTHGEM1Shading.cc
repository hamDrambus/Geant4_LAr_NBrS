...
DetectorConstructionTHGEM1Shading::DetectorConstructionTHGEM1Shading() : fCheckOverlaps(gPars::general.check_geometry_overlap)
{
	SetSizeAndPosition();
}

DetectorConstructionTHGEM1Shading::~DetectorConstructionTHGEM1Shading()
{}

G4VPhysicalVolume * DetectorConstructionTHGEM1Shading::Construct()
{
	defineMaterials();
	defineSurfaces();
  ...
  G4LogicalSkinSurface* sur_sensor = new G4LogicalSkinSurface("sensor_surface", logic_sensor, SensorSurface);
...
void DetectorConstructionTHGEM1Shading::CreateTHGEM1Cell() //Must be the same as in gmsh-elmer simulation
{
...
void DetectorConstructionTHGEM1Shading::ConstructSDandField()
{
...
void DetectorConstructionTHGEM1Shading::defineSurfaces()
{
	//*********************************************************************************
	//unified model
	...
	//-----------------------------------------------------------------------------
  // SensorSurface
	SensorSurface = new G4OpticalSurface("SensorSurface", unified);
	SensorSurface->SetType(dielectric_metal);
	SensorSurface->SetModel(unified);
	SensorSurface->SetFinish(polished);
	SensorSurface->SetSigmaAlpha(0.);
  ...
  SensorSurface->SetMaterialPropertiesTable(SiPM_MaterialProperty);
}

void DetectorConstructionTHGEM1Shading::SetSizeAndPosition()
{
...
void DetectorConstructionTHGEM1Shading::defineMaterials()
{
