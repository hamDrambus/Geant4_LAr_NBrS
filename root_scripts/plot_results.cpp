...
void plot_results(void)
{
  ...
  //std::string input_file = "../tests/test_01_SiPM_shading_no_grid_no_PMMA/generated.dat";
  std::string input_file = "../tests/test_01_SiPM_shading_no_grid_no_PMMA/recorded.dat";
  PlotInfo plot_info;
