...
namespace gPars
{
    ...
    struct DetectorOptics {
        ...
        std::string FSQ_RG715_absorption_length_filename;
        std::string FSQ_RG715_rindex_filename;
    };
    ...
    struct MediumProperties {
        ...
        // If true then incorrect computations (such as division by 0,
        // infinities, DBL_MAX) throw error. Otherwise default values are used.
        bool pedantic_calculations;
